...
void VGG11(engine::kind engine_kind) {
    ...
    // softmax back
    auto softmax_back_desc = softmax_backward::desc(loss_diff_md, softmax_src_md, 1);
    auto softmax_back_pd = softmax_backward::primitive_desc(softmax_back_desc, eng, softmax_pd);
